...
static void sitronix_ts_reset_ic(void)
{
        int ret = gpio_request(SITRONIX_RESET_GPIO, "GPX17");//GPIO引脚申请
        s3c_gpio_cfgpin(SITRONIX_RESET_GPIO, S3C_GPIO_OUTPUT);//
//if(ret ==0 ){
	...
	msleep(1);
        gpio_direction_output(SITRONIX_RESET_GPIO, 0);
...
const unsigned short sitronix_i2c_addr[] = {0x55, I2C_CLIENT_END};
//ADu end
#endif // SITRONIX_MULTI_SLAVE_ADDR
